      ...
      <main className="flex-grow flex flex-col items-center justify-center p-5 py-10 relative">
        <div className="w-full max-w-md relative z-10">
          ...
          <motion.div 
            ...
            className="bg-white rounded-xl shadow-premium overflow-hidden border border-zinc-100"
          >
            ...
            <form className="p-6 space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 text-sm group-focus-within:text-primary transition-colors">mail</span>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 text-sm group-focus-within:text-primary transition-colors">lock</span>
                  ...
                  <button className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-primary transition-colors" type="button">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-4 bg-primary text-white font-bold text-lg rounded-full shadow-lg hover:bg-primary-dark transition-all duration-200" 
                type="submit"
              >
                Sign In
              </motion.button>
            ...
            <div className="px-6 pb-6 pt-2">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-3 px-4 border border-zinc-200 rounded-xl flex items-center justify-center gap-3 font-semibold text-sm text-on-surface transition-colors"
              >
